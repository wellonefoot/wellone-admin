# WellOne Admin v73 — Inventory, Barcode & Offers
...
- Camera/hardware/manual barcode lookup. Existing barcode opens the product for editing; an unknown barcode opens a new product form with that code assigned.
