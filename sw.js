const CACHE_VERSION = 'wellone-admin-v51-variant-availability';
const SHELL_CACHE = `${CACHE_VERSION}-shell`;
const RUNTIME_CACHE = `${CACHE_VERSION}-runtime`;
const SHELL_ASSETS = [
  './', './index.html', './css/admin.css?v=50', './js/admin-config.js?v=50', './js/admin.js?v=51', './js/pwa-install.js?v=50',
