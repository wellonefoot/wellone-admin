...
async function ensureSubcategory(categoryId, name){
  ...
  if(error) throw error;
  const sub = {id:data.id, category_id:data.category_id, name:data.name, active:true};
